...
- Recommend AWS-native architecture patterns (microservices on EKS, serverless with Lambda, etc.)
...
- Compute: Amazon EC2, AWS Lambda, Amazon ECS, Amazon EKS, AWS Fargate

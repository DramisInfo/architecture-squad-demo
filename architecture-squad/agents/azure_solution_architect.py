...
- Recommend Azure-native architecture patterns (microservices on AKS, serverless with Functions, etc.)
...
- Compute: Azure App Service, Azure Functions, Azure Container Instances, Azure Kubernetes Service

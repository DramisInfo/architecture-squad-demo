...
async def call_tool_and_verify_success(client, tool_name: str, params: Dict[str, Any]) -> Dict[str, Any]:
    """
...
async def verify_diagram_response(response_data: Dict[str, Any], expected_format: str = "png"):
    """
